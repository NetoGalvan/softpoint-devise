...
import { Card, CardHeader, CardBody, Button, Input, Spinner } from '@/components/common';
...
export const EditPropertyPage: React.FC = () => {
    ...
    const fetchProperty = async () => {
      ...
      try {
        ...
        reset({
          ...
          real_estate_type: propertyData.real_estate_type,
          street: propertyData.street,
          external_number: propertyData.external_number,
          internal_number: propertyData.internal_number || '',
  ...
  const onSubmit = async (data: PropertyFormData) => {
    ...
    try {
      ...
      await propertiesApi.update(parseInt(id), cleanData);

      toast.success('Property updated successfully!');
      navigate('/properties');
    } catch (error) {
      const apiError = error as ApiError;
      toast.error(apiError.message || 'Failed to update property');
  ...
  // Show loading spinner while fetching property
  if (isLoading) {
    return (
      <DashboardLayout>
    ...
    return (
      <DashboardLayout>
        <div className="text-center py-12">
          ...
          <Link to="/properties" className="text-blue-600 hover:underline mt-4">
            Back to Properties
          </Link>
        </div>
      </DashboardLayout>
                ...
                {(propertyType === 'land' ||
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-800">
                      ...
                      {propertyType === 'land' ? 'land' : 'commercial ground'}{' '}
                      properties, internal number and bathrooms are optional and
                      will default to appropriate values.
                    </p>
                  </div>
                )}

                {/* Metadata */}
                <div className="border-t pt-6 bg-gray-50 -mx-6 -mb-6 px-6 py-4 rounded-b-lg">
